...
const Leaderboard = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const capsRes = await axios.get(`${API}/leaderboard/caps`);
      const chaseRes = await axios.get(`${API}/leaderboard/chase-masters`);
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                      ...
                      <div style={{
                        ...
                        background: isWinner ? '#ea580c' : 'rgba(255,255,255,0.06)',
                ...
                return (
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                      ...
                      <div style={{
                        width: '32px', height: '32px', borderRadius: '50%',
                        background: isWinner ? '#7e22ce' : 'rgba(255,255,255,0.06)',
                        color: isWinner ? '#fff' : 'var(--text-muted)',
                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                        fontWeight: '800', fontSize: '0.85rem'
                      }}>
                ...
                return (
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                      ...
                      <div style={{
                        width: '32px', height: '32px', borderRadius: '50%',
                        background: isWinner ? '#2a9d8f' : 'rgba(255,255,255,0.06)',
                        color: isWinner ? '#fff' : 'var(--text-muted)',
                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                        fontWeight: '800', fontSize: '0.85rem'
                      }}>
                    ...
                    <div style={{ display: 'flex', gap: '2rem', alignItems: 'center', flexWrap: 'wrap' }}>
                      <div style={{ textAlign: 'center' }}>
                        <div style={{ fontSize: '0.68rem', color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Chase Runs</div>
                        <div style={{ fontSize: '1.4rem', fontWeight: '900', color: '#2a9d8f' }}>{item.chaseRuns}</div>
                      </div>
                      <div style={{ textAlign: 'center' }}>
                        <div style={{ fontSize: '0.68rem', color: 'var(--text-muted)', textTransform: 'uppercase' }}>Chase Index Score</div>
                        <div style={{ fontSize: '1.1rem', fontWeight: '850', color: 'var(--secondary-color)' }}>{item.score.toFixed(1)}</div>
                      </div>
                    </div>
                  </div>
                );
